...
class Mqtt_client():
    ...
    def on_message(self, client, userdata, msg):
        ...
        freezer_id = topic.split("/")[2]
        print("message from:" + topic, m_decode)
        mainwin.connectionDock.update_btn_state(m_decode, freezer_id)
...
class ConnectionDock(QDockWidget):
    ...
    def update_btn_state(self, m_decode, freezer_id):
        temperature = m_decode.split(" ")[1]
        global ON
        if float(temperature) > temp_tsh:
            self.mc.publish_to(f'customer/{customer_id}/machine/freezer/{freezer_id}', m_decode)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        # set up main window
        self.setGeometry(30, 300, 300, 100)
