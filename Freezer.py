...
global clientname, CONNECTED, current_temperature
CONNECTED = False
r = random.randrange(1, 10000000)
clientname = "IOT_client-Id234-" + str(r)
freezer_id = random.randrange(1,100)
DHT_topic = f'machine/freezer/{freezer_id}'
...
class ConnectionDock(QDockWidget):
    ...
    def push_button_click(self):
        self.mc.publish_to(self.ePublisherTopic.text(), '"customer_id":1')
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('Freezer Temperature')
    ...
    def update_data(self):
        ...
        # print('Next update')
        current_temperature = round(random.uniform(0, 100), 2)
        current_data = 'Temperature: ' + str(current_temperature)
        self.connectionDock.Temperature.setText(str(current_temperature))
