...
current_topic = f'customer/{customer_id}/machine/freezer/#'
global ON
ON = True
...
class ConnectionDock(QDockWidget):
    ...
    def __init__(self, mc):
        ...
        self.eSubscribeTopic.setText(current_topic)

        self.ePushtbtn = QPushButton("", self)
        self.ePushtbtn.setStyleSheet("background-color: gray")

        self.machineIDText = QLabel("")
        self.resetButton = QPushButton("Fix Machine", self)
        ...
        formLayot.addRow("Machine Status", self.ePushtbtn)
        formLayot.addRow("Machine ID", self.machineIDText)
